...
const AdvancedLoansMaturityTable = ({ data }) => {
  return (
    <table className="custom-table" style={{ marginBottom: '20px', width: '100%', tableLayout: 'fixed' }}>
      <thead>
        {/* First header row */}
        <tr>
          <th rowSpan="2" style={{ fontWeight: 'bold', width: '18%', textAlign: 'left' }}>ADVANCED LOANS BY MATURITY</th>
...
const AdvancedLoansCategoryTable = ({ data }) => {
  return (
    <table className="custom-table" style={{ marginBottom: '20px', width: '100%', tableLayout: 'fixed' }}>
      <thead>
        {/* First header row */}
        <tr>
          <th rowSpan="2" style={{ fontWeight: 'bold', width: '18%', textAlign: 'left' }}>ADVANCED LOANS BY CATEGORY</th>
          <th colSpan="2" style={{ fontWeight: 'bold', width: '25%', textAlign: 'center' }}>Number of loans</th>
          <th colSpan="2" style={{ fontWeight: 'bold', width: '30%', textAlign: 'center' }}>Amount of loans</th>
        </tr>
        {/* Second header row */}
...
const AdvancedLoansGrid = () => {
  const { themeClass } = useTheme();

  return (
    <div className={`${themeClass} grid-container`} style={{ width: '700px', margin: '0 auto' }}>
      <AdvancedLoansMaturityTable data={dataSourceMaturity} />
      <AdvancedLoansCategoryTable data={dataSourceCategory} />
    </div>
  );
};

export default AdvancedLoansGrid;