...
const IncomeExpenditureGrid = () => {
  ...
  const endpoint = 'data/income-expenditure-fact/3/';
    ...
    try {
      ...
      const dataSource = [
        ...
        { 
          ...
          amount1: formattedData.memberLoanInterest, 
          amount2: '', 
          amount3: '' 
        },
        { 
          ...
          amount1: formattedData.otherInterestIncome, 
          amount2: '', 
          amount3: '' 
        },
        { 
          ...
          amount1: formattedData.otherIncome, 
          amount2: '', 
          amount3: '' 
        },
        { 
          ...
          amount1: '', 
          amount2: formattedData.totalIncome, 
          amount3: '', 
        ...
        { 
          ...
          amount1: formattedData.employmentCosts, 
          amount2: '', 
          amount3: '' 
        },
        { 
          key: '6', 
          description: 'Other management costs', 
          amount1: formattedData.otherManagementCosts, 
          amount2: '', 
          amount3: '' 
        },
        { 
          ...
          amount1: formattedData.depreciationCosts, 
          amount2: '', 
          amount3: '' },
        { 
          key: '8', 
          description: 'Net member loan impairment', 
          amount1: formattedData.netMemberLoanImpairment, 
          amount2: '', 
          amount3: '' 
        },
        { 
          ...
          description: 'Total expenditure', 
          amount1: '', 
          amount2: formattedData.totalExpenditure, 
          amount3: '', 
          className: 'border-top-1' 
        },
        { 
          ...
          amount1: '', 
          amount2: '', 
          amount3: formattedData.surplusOrDeficit, 
