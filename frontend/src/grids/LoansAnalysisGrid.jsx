...
const LoanAnalysisGrid = () => {
  ...
  const endpoint1 = 'data/outstanding-loan-maturity-fact/?returnId=3';
  const endpoint2 = 'data/outstanding-loan-category-fact/?returnId=3';
  const endpoint3 = 'data/advanced-loan-maturity-fact/?returnId=3';
  const endpoint4 = 'data/advanced-loan-category-fact/?returnId=3';
